...
use std::io::Write;
use draw_utils::{core::{print_line, print_terminal}, draw_ascii, draw_horizontal_line, draw_vertical_line, set_to_blank, text_chars, text_draw, text_with_line_breaker};
...
fn main() {
    ...
    loop { //game main loop 
        ...
        draw_vertical_line(0, CANVA.y, 0, &mut array, '|');
        draw_vertical_line(0, CANVA.y, 1, &mut array, '|');
        draw_vertical_line(0, CANVA.y, CANVA.x - 1, &mut array, '|');
        draw_vertical_line(0, CANVA.y, CANVA.x - 2, &mut array, '|');
...
fn handle_menu(array1: &mut [[char; CANVA.yu]; CANVA.xu], state: &mut GameState) {
...
fn handle_turorial(array1: &mut [[char; CANVA.yu]; CANVA.xu], state: &mut GameState) {
...
fn handle_playing(array1: &mut [[char; CANVA.yu]; CANVA.xu], state: &mut GameState, points: &mut [i32; 1]) {
...
fn handle_won(array1: &mut [[char; CANVA.yu]; CANVA.xu], state: &mut GameState) {
...
fn handle_lost(array1: &mut [[char; CANVA.yu]; CANVA.xu], state: &mut GameState) {
